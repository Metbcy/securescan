...
- [Install](./install.md)
- [Quick start: your first scan](./quick-start.md)
- [Architecture overview](./architecture.md)

# Scanning

- [How scans work](./scanning/how-scans-work.md)
- [Scan types](./scanning/scan-types.md)
- [Supported scanners](./scanning/supported-scanners.md)
- [Findings & severity](./scanning/findings-severity.md)
- [Suppression](./scanning/suppression.md)
- [Triage workflow](./scanning/triage.md)
- [Compliance](./scanning/compliance.md)

# Dashboard

- [Tour](./dashboard/tour.md)
- [Real-time scan progress](./dashboard/realtime.md)
- [Notifications](./dashboard/notifications.md)
- [Webhooks](./dashboard/webhooks.md)
- [SBOM](./dashboard/sbom.md)
...
- [Production checklist](./auth/production-checklist.md)
...
- [Local config (.env)](./deployment/local-config.md)
